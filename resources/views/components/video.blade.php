...
<div x-data="{playing:false, muted:false}" class="relative w-full h-full m-auto"
    ...
    <video x-ref="player" class="h-full max-h-[500px] w-full">
    ...
    <div x-cloak x-show="!playing" @click="$refs.player.play(); playing=true" class="absolute z-10 inset-0 flex items-center justify-center w-full h-full cursor-pointer">
    ...
    <div x-cloak x-show="playing" @click="$refs.player.pause(); playing=false" class="absolute z-10 inset-0 flex items-center justify-center w-full h-full cursor-pointer">
    ...
    <div x-cloak x-show="!muted" @click="$refs.player.muted=true; muted=true" class="absolute z-[100] bottom-2 right-2 m-4 bg-gray-900 text-white rounded-lg p-1 cursor-pointer">
    ...
    <div x-cloak x-show="muted" @click="$refs.player.muted=false; muted=false" class="absolute z-[100] bottom-2 right-2 m-4 bg-gray-900 text-white rounded-lg p-1 cursor-pointer">
